...
console.log(failures === 0 ? '\nfield, gate, review, intervention, packet, bank, rig, shelf, markdown and index models: all checks pass' : `\nfield, gate, review, intervention, packet, bank, rig, shelf, markdown and index models: ${failures} FAILED`);
